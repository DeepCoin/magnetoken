...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("magnetoken-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Magnetoken " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"magnetoken.net", "seed.ppcoin.net"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"magnetoken.net", "tnseed.ppcoin.net"},
    {"primeseed.muuttuja.org", "primeseed.muuttuja.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Magnetoken is probably already running."), addrBind.ToString().c_str());
        else
